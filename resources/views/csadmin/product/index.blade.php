                     ...
                     <table class="table align-middle">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td ><img style="object-fit:cover;width:50px ;height:50px" src="@if(isset($value->product_image) && $value->product_image != ''){{env('PRODUCT_IMAGE')}}{{$value->product_image}} @else {{env('NO_IMAGE')}} @endif" alt=""></td>
