...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <form method="POST" action="{{ route('csadmin.page.addpageprocess') }}"enctype="multipart/form-data"
                    id=formsubmit>
                    @csrf
                    <input type="hidden" name="page_id"
                        value="{{ isset($pageData->page_id) && $pageData->page_id != '' ? $pageData->page_id : 0 }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            class="form-control required @error('page_name') is-invalid @enderror"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text"
                                                class="form-control required @error('page_url') is-invalid @enderror"
                                                id="page_url_id" aria-describedby="basic-addon3" name="page_url"
                                                value="@if (isset($pageData->page_url)) {{ $pageData->page_url }}@else{{ '' }} @endif">
                                            @error('page_url')
                                                <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <div class="fileimg d-flex">
                                            <img class="fileimg-preview logoimage mediaImage mt-2"
                                                src="@if (isset($pageData->page_header_image) && $pageData->page_header_image != '') {{ env('PAGE_IMAGE') }}{{ $pageData->page_header_image }} @else {{ env('NO_IMAGE') }} @endif"
                    ...
                    <div class="card bg-secondary rounded p-2">
                        ...
                        <div class="card-body justify-content-sm-center">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        class="form-control required @error('page_meta_title') is-invalid @enderror"
                        ...
                        <div class="card-footer  d-flex justify-content-between">
                            <button type="button" id='button' class="btn btn-success"
                                ...
                                @if (isset($pageData->page_id) && $pageData->page_id != '')
                                    {{ 'Update' }}@else{{ 'Save' }}
                                @endif
                            </button>
                        </div>
